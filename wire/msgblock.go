...
func (msg *MsgBlock)BronDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	if txCount > maxTxPerBlock {
		...
		return messageError("MsgBlock.BronDecode", str)
	}

	msg.Transactions = make([]*MsgTx, 0, txCount)
	for i := uint64(0); i < txCount; i++ {
		tx := MsgTx{}
		err := tx.BronDecode(r, pver, enc)
		if err != nil {
			return err
		}
		msg.Transactions = append(msg.Transactions, &tx)
...
// Version field in the block.  This function differs fromBronDecode in that
//BronDecode decodes from the brocoin wire protocol as it was sent across the
...
func (msg *MsgBlock) Deserialize(r io.Reader) error {
	...
	// a result, make use ofBronDecode.
	//
	// Passing an encoding type of WitnessEncoding toBronEncode for the
	...
	return msg.BronDecode(r, 0, WitnessEncoding)
}
...
func (msg *MsgBlock) DeserializeNoWitness(r io.Reader) error {
	return msg.BronDecode(r, 0, BaseEncoding)
}
...
func (msg *MsgBlock)BronEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
...
// This function differs fromBronEncode in thatBronEncode encodes the block to
...
func (msg *MsgBlock) Serialize(w io.Writer) error {
	// At the current time, there is no difference between the wire encoding
	// at protocol version 0 and the stable long-term storage format.  As
	// a result, make use ofBronEncode.
	//
	...
	// serialization structure defined in BIP0141.
	return msg.BronEncode(w, 0, WitnessEncoding)
}
...
func (msg *MsgBlock) SerializeNoWitness(w io.Writer) error {
	return msg.BronEncode(w, 0, BaseEncoding)
}
