...
API.  This client has been tested with brond (https://github.com/brsuite/brond),
bronwallet (https://github.com/brsuite/bronwallet), and
brocoin core (https://github.com/brocoin).
...
detected by type asserting the error in a *bronjson.RPCError.  For example, to
detect if a command is unimplemented by the remote RPC server:

  amount, err := client.GetBalance("")
  if err != nil {
  	if jerr, ok := err.(*bronjson.RPCError); ok {
  		switch jerr.Code {
  		case bronjson.ErrRPCUnimplemented:
