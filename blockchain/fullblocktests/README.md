...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/brsuite/brond/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/brsuite/brond/blockchain/fullblocktests
```
