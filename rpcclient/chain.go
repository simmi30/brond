...
func unmarshalPartialGetBlockChainInfoResult(res []byte) (*bronjson.GetBlockChainInfoResult, error) {
...
func unmarshalGetBlockChainInfoResultSoftForks(chainInfo *bronjson.GetBlockChainInfoResult,
	version BackendVersion, res []byte) error {

	switch version {
	// Versions of brocoind on or after v0.19.0 use the unified format.
	case BrocoindPost19:
		var softForks bronjson.UnifiedSoftForks
	...
	default:
		var softForks bronjson.SoftForks
		if err := json.Unmarshal(res, &softForks); err != nil {
			return err
		}
