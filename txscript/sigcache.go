...
func (s *SigCache) Exists(sigHash chainhash.Hash, sig *bronec.Signature, pubKey *bronec.PublicKey) bool {
	s.RLock()
...
func (s *SigCache) Add(sigHash chainhash.Hash, sig *bronec.Signature, pubKey *bronec.PublicKey) {
	s.Lock()
	defer s.Unlock()
