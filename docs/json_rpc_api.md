...
* Unlike brocoind that has the wallet and chain intermingled in the same process
  ...
  [bronwallet](https://github.com/brsuite/bronwallet).
...
such as [bronwallet](https://github.com/brsuite/bronwallet) for inter-process
...
The original brocoind/brocoin-qt JSON-RPC API documentation is available at [https://en.brocoin.it/wiki/Original_Brocoin_client/API_Calls_list](https://en.brocoin.it/wiki/Original_Brocoin_client/API_Calls_list)
...
|Returns (verbose=true)|`{ (json object)`<br />&nbsp;&nbsp;`"transactionhash": { (json object)`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"size": n, (numeric) transaction size in bytes`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"vsize": n, (numeric) transaction virtual size`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"weight": n, (numeric) The transaction's weight (between vsize*4-3 and vsize*4)`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"fee" : n, (numeric) transaction fee in brocoins`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"time": n, (numeric) local time transaction entered pool in seconds since 1 Jan 1970 GMT`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"height": n, (numeric) block height when transaction entered the pool`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"startingpriority": n, (numeric) priority when transaction entered the pool`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"currentpriority": n, (numeric) current priority`<br />&nbsp;&nbsp;&nbsp;&nbsp;`"depends": [ (json array) unconfirmed transactions used as inputs for this transaction`<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`"transactionhash", (string) hash of the parent transaction`<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`...`<br />&nbsp;&nbsp;&nbsp;&nbsp;`]`<br />&nbsp;&nbsp;`}, ...`<br />`}`|
...
|Returns|`{ (json object)`<br />&nbsp;&nbsp;`"isvalid": true or false,  (bool) whether or not the address is valid.`<br />&nbsp;&nbsp;`"address": "brocoinaddress", (string) the brocoin address validated.`<br />}|
[Return to Overview](#MethodOverview)<br />
...
|Parameters|1. Addresses (JSON array, required)<br />&nbsp;`[ (json array of strings)`<br />&nbsp;&nbsp;`"brocoinaddress", (string) the brocoin address`<br />&nbsp;&nbsp;`...`<br />&nbsp;`]`|
...
|Parameters|1. BeginBlock (string, required) block hash to begin rescanning from<br />2. Addresses (JSON array, required)<br />&nbsp;`[ (json array of strings)`<br />&nbsp;&nbsp;`"brocoinaddress", (string) the brocoin address`<br />&nbsp;&nbsp;`...` <br />&nbsp;`]`<br />3. Outpoints (JSON array, required)<br />&nbsp;`[ (JSON array)`<br />&nbsp;&nbsp;`{ (JSON object)`<br />&nbsp;&nbsp;&nbsp;`"hash":"data", (string) the hex-encoded bytes of the outpoint hash`<br />&nbsp;&nbsp;&nbsp;`"index":n (numeric) the txout index of the outpoint`<br />&nbsp;&nbsp;`},`<br />&nbsp;&nbsp;`...`<br />&nbsp;`]`<br />4. EndBlock (string, optional) hash of final block to rescan|
...
[bronrpcclient](https://github.com/brsuite/bronrpcclient) package.
...
[bronrpcclient](https://github.com/brsuite/bronrpcclient) package to connect with
...
import (
	"github.com/brsuite/bronrpcclient"
...
func main() {
	...
	// exits.
	connCfg := &bronrpcclient.ConnConfig{
		Host:         "localhost:8360",
		Endpoint:     "ws",
		User:         "yourrpcuser",
		Pass:         "yourrpcpass",
	...
	client, err := bronrpcclient.New(connCfg, nil)
	if err != nil {
		log.Fatal(err)
	}
...
func main() {
	...
	// notifications.
	ntfnHandlers := bronrpcclient.NotificationHandlers{
	...
	client, err := bronrpcclient.New(connCfg, &ntfnHandlers)
	if err != nil {
		log.Fatal(err)
	}
