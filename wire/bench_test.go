...
func BenchmarkDecodeGetHeaders(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.BronEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgGetHeaders.BronEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
	...
	for i := 0; i < b.N; i++ {
		r.Seek(0, 0)
		msg.BronDecode(r, pver, LatestEncoding)
	}
}
...
func BenchmarkDecodeHeaders(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.BronEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgHeaders.BronEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeGetBlocks(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.BronEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgGetBlocks.BronEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeAddr(b *testing.B) {
	...
	// Serialize it so the bytes are available to test the decode below.
	var bb bytes.Buffer
	if err := ma.BronEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgAddr.BronEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeInv(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.BronEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgInv.BronEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeNotFound(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.BronEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgNotFound.BronEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeMerkleBlock(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.BronEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgMerkleBlock.BronEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
