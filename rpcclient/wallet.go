...
func (r FutureGetTransactionResult) Receive() (*bronjson.GetTransactionResult, error) {
	...
	var getTx bronjson.GetTransactionResult
...
func (c *Client) GetTransactionAsync(txHash *chainhash.Hash) FutureGetTransactionResult {
	...
	cmd := bronjson.NewGetTransactionCmd(hash, nil)
...
func (c *Client) GetTransaction(txHash *chainhash.Hash) (*bronjson.GetTransactionResult, error) {
...
func (r FutureListTransactionsResult) Receive() ([]bronjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var transactions []bronjson.ListTransactionsResult
...
func (c *Client) ListTransactionsAsync(account string) FutureListTransactionsResult {
	cmd := bronjson.NewListTransactionsCmd(&account, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactions(account string) ([]bronjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountAsync(account string, count int) FutureListTransactionsResult {
	cmd := bronjson.NewListTransactionsCmd(&account, &count, nil, nil)
	return c.sendCmd(cmd)
}
...
// different options.
func (c *Client) ListTransactionsCount(account string, count int) ([]bronjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountFromAsync(account string, count, from int) FutureListTransactionsResult {
	cmd := bronjson.NewListTransactionsCmd(&account, &count, &from, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactionsCountFrom(account string, count, from int) ([]bronjson.ListTransactionsResult, error) {
...
func (r FutureListUnspentResult) Receive() ([]bronjson.ListUnspentResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var unspent []bronjson.ListUnspentResult
...
func (c *Client) ListUnspentAsync() FutureListUnspentResult {
	cmd := bronjson.NewListUnspentCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinAsync(minConf int) FutureListUnspentResult {
	cmd := bronjson.NewListUnspentCmd(&minConf, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAsync(minConf, maxConf int) FutureListUnspentResult {
	cmd := bronjson.NewListUnspentCmd(&minConf, &maxConf, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []bronutil.Address) FutureListUnspentResult {
	...
	cmd := bronjson.NewListUnspentCmd(&minConf, &maxConf, &addrStrs)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspent() ([]bronjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMin(minConf int) ([]bronjson.ListUnspentResult, error) {
...
// a filter.
func (c *Client) ListUnspentMinMax(minConf, maxConf int) ([]bronjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []bronutil.Address) ([]bronjson.ListUnspentResult, error) {
...
func (r FutureListSinceBlockResult) Receive() (*bronjson.ListSinceBlockResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var listResult bronjson.ListSinceBlockResult
...
func (c *Client) ListSinceBlockAsync(blockHash *chainhash.Hash) FutureListSinceBlockResult {
	var hash *string
	if blockHash != nil {
		hash = bronjson.String(blockHash.String())
	}

	cmd := bronjson.NewListSinceBlockCmd(hash, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlock(blockHash *chainhash.Hash) (*bronjson.ListSinceBlockResult, error) {
...
func (c *Client) ListSinceBlockMinConfAsync(blockHash *chainhash.Hash, minConfirms int) FutureListSinceBlockResult {
	...
	cmd := bronjson.NewListSinceBlockCmd(hash, &minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConf(blockHash *chainhash.Hash, minConfirms int) (*bronjson.ListSinceBlockResult, error) {
...
func (c *Client) LockUnspentAsync(unlock bool, ops []*wire.OutPoint) FutureLockUnspentResult {
	outputs := make([]bronjson.TransactionInput, len(ops))
	for i, op := range ops {
		outputs[i] = bronjson.TransactionInput{
			Txid: op.Hash.String(),
			Vout: op.Index,
		}
	}
	cmd := bronjson.NewLockUnspentCmd(unlock, outputs)
	return c.sendCmd(cmd)
}
...
func (r FutureListLockUnspentResult) Receive() ([]*wire.OutPoint, error) {
	...
	var inputs []bronjson.TransactionInput
...
func (c *Client) ListLockUnspentAsync() FutureListLockUnspentResult {
	cmd := bronjson.NewListLockUnspentCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SetTxFeeAsync(fee bronutil.Amount) FutureSetTxFeeResult {
	cmd := bronjson.NewSetTxFeeCmd(fee.ToBRON())
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddressAsync(address bronutil.Address, amount bronutil.Amount) FutureSendToAddressResult {
	...
	cmd := bronjson.NewSendToAddressCmd(addr, amount.ToBRON(), nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddressCommentAsync(address bronutil.Address,
	...
	addr := address.EncodeAddress()
	cmd := bronjson.NewSendToAddressCmd(addr, amount.ToBRON(), &comment,
		&commentTo)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendFromAsync(fromAccount string, toAddress bronutil.Address, amount bronutil.Amount) FutureSendFromResult {
	...
	cmd := bronjson.NewSendFromCmd(fromAccount, addr, amount.ToBRON(), nil,
		nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress bronutil.Address, amount bronutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := bronjson.NewSendFromCmd(fromAccount, addr, amount.ToBRON(),
		&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[bronutil.Address]bronutil.Amount) FutureSendManyResult {
	...
	for addr, amount := range amounts {
		convertedAmounts[addr.EncodeAddress()] = amount.ToBRON()
	}
	cmd := bronjson.NewSendManyCmd(fromAccount, convertedAmounts, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	...
	cmd := bronjson.NewSendManyCmd(fromAccount, convertedAmounts,
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []bronutil.Address, account string) FutureAddMultisigAddressResult {
	...
	cmd := bronjson.NewAddMultisigAddressCmd(requiredSigs, addrs, &account)
	return c.sendCmd(cmd)
}
...
func (r FutureCreateMultisigResult) Receive() (*bronjson.CreateMultiSigResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var multisigRes bronjson.CreateMultiSigResult
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []bronutil.Address) FutureCreateMultisigResult {
	...
	cmd := bronjson.NewCreateMultisigCmd(requiredSigs, addrs)
	return c.sendCmd(cmd)
}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []bronutil.Address) (*bronjson.CreateMultiSigResult, error) {
...
func (c *Client) CreateNewAccountAsync(account string) FutureCreateNewAccountResult {
	cmd := bronjson.NewCreateNewAccountCmd(account)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNewAddressAsync(account string) FutureGetNewAddressResult {
	cmd := bronjson.NewGetNewAddressCmd(&account)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawChangeAddressAsync(account string) FutureGetRawChangeAddressResult {
	cmd := bronjson.NewGetRawChangeAddressCmd(&account)
	return c.sendCmd(cmd)
}
...
func (c *Client) AddWitnessAddressAsync(address string) FutureAddWitnessAddressResult {
	cmd := bronjson.NewAddWitnessAddressCmd(address)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetAccountAddressAsync(account string) FutureGetAccountAddressResult {
	cmd := bronjson.NewGetAccountAddressCmd(account)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetAccountAsync(address bronutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
	cmd := bronjson.NewGetAccountCmd(addr)
	return c.sendCmd(cmd)
}
...
func (c *Client) SetAccountAsync(address bronutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
	cmd := bronjson.NewSetAccountCmd(addr, account)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetAddressesByAccountAsync(account string) FutureGetAddressesByAccountResult {
	cmd := bronjson.NewGetAddressesByAccountCmd(account)
	return c.sendCmd(cmd)
}
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount bronutil.Amount) FutureMoveResult {
	cmd := bronjson.NewMoveCmd(fromAccount, toAccount, amount.ToBRON(), nil,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	...
	cmd := bronjson.NewMoveCmd(fromAccount, toAccount, amount.ToBRON(),
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) RenameAccountAsync(oldAccount, newAccount string) FutureRenameAccountResult {
	cmd := bronjson.NewRenameAccountCmd(oldAccount, newAccount)
	return c.sendCmd(cmd)
}
...
func (r FutureValidateAddressResult) Receive() (*bronjson.ValidateAddressWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var addrResult bronjson.ValidateAddressWalletResult
...
func (c *Client) ValidateAddressAsync(address bronutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
	cmd := bronjson.NewValidateAddressCmd(addr)
	return c.sendCmd(cmd)
}

// ValidateAddress returns information about the given brocoin address.
func (c *Client) ValidateAddress(address bronutil.Address) (*bronjson.ValidateAddressWalletResult, error) {
...
func (c *Client) KeyPoolRefillAsync() FutureKeyPoolRefillResult {
	cmd := bronjson.NewKeyPoolRefillCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) KeyPoolRefillSizeAsync(newSize uint) FutureKeyPoolRefillResult {
	cmd := bronjson.NewKeyPoolRefillCmd(&newSize)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccountsAsync() FutureListAccountsResult {
	cmd := bronjson.NewListAccountsCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccountsMinConfAsync(minConfirms int) FutureListAccountsResult {
	cmd := bronjson.NewListAccountsCmd(&minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalanceAsync(account string) FutureGetBalanceResult {
	cmd := bronjson.NewGetBalanceCmd(&account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalanceMinConfAsync(account string, minConfirms int) FutureGetBalanceResult {
	cmd := bronjson.NewGetBalanceCmd(&account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountAsync(account string) FutureGetReceivedByAccountResult {
	cmd := bronjson.NewGetReceivedByAccountCmd(account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountMinConfAsync(account string, minConfirms int) FutureGetReceivedByAccountResult {
	cmd := bronjson.NewGetReceivedByAccountCmd(account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetUnconfirmedBalanceAsync(account string) FutureGetUnconfirmedBalanceResult {
	cmd := bronjson.NewGetUnconfirmedBalanceCmd(&account)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAddressAsync(address bronutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := bronjson.NewGetReceivedByAddressCmd(addr, nil)
	return c.sendCmd(cmd)
...
func (c *Client) GetReceivedByAddressMinConfAsync(address bronutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := bronjson.NewGetReceivedByAddressCmd(addr, &minConfirms)
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns a list of
// balances by account.
func (r FutureListReceivedByAccountResult) Receive() ([]bronjson.ListReceivedByAccountResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []bronjson.ListReceivedByAccountResult
...
func (c *Client) ListReceivedByAccountAsync() FutureListReceivedByAccountResult {
	cmd := bronjson.NewListReceivedByAccountCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccount() ([]bronjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountMinConfAsync(minConfirms int) FutureListReceivedByAccountResult {
	cmd := bronjson.NewListReceivedByAccountCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountMinConf(minConfirms int) ([]bronjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAccountResult {
	cmd := bronjson.NewListReceivedByAccountCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountIncludeEmpty(minConfirms int, includeEmpty bool) ([]bronjson.ListReceivedByAccountResult, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by address.
func (r FutureListReceivedByAddressResult) Receive() ([]bronjson.ListReceivedByAddressResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []bronjson.ListReceivedByAddressResult
	err = json.Unmarshal(res, &received)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListReceivedByAddressAsync() FutureListReceivedByAddressResult {
	cmd := bronjson.NewListReceivedByAddressCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddress() ([]bronjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressMinConfAsync(minConfirms int) FutureListReceivedByAddressResult {
	cmd := bronjson.NewListReceivedByAddressCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
// received any payments in the results.
func (c *Client) ListReceivedByAddressMinConf(minConfirms int) ([]bronjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAddressResult {
	cmd := bronjson.NewListReceivedByAddressCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressIncludeEmpty(minConfirms int, includeEmpty bool) ([]bronjson.ListReceivedByAddressResult, error) {
...
func (c *Client) WalletPassphrase(passphrase string, timeoutSecs int64) error {
	cmd := bronjson.NewWalletPassphraseCmd(passphrase, timeoutSecs)
...
func (c *Client) WalletPassphraseChangeAsync(old, new string) FutureWalletPassphraseChangeResult {
	cmd := bronjson.NewWalletPassphraseChangeCmd(old, new)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignMessageAsync(address bronutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
	cmd := bronjson.NewSignMessageCmd(addr, message)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyMessageAsync(address bronutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
	cmd := bronjson.NewVerifyMessageCmd(addr, signature, message)
	return c.sendCmd(cmd)
}
...
func (c *Client) DumpPrivKeyAsync(address bronutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
	cmd := bronjson.NewDumpPrivKeyCmd(addr)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportAddressAsync(address string) FutureImportAddressResult {
	cmd := bronjson.NewImportAddressCmd(address, "", nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportAddressRescanAsync(address string, account string, rescan bool) FutureImportAddressResult {
	cmd := bronjson.NewImportAddressCmd(address, account, &rescan)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *bronutil.WIF) FutureImportPrivKeyResult {
	...
	cmd := bronjson.NewImportPrivKeyCmd(wif, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *bronutil.WIF, label string) FutureImportPrivKeyResult {
	...
	cmd := bronjson.NewImportPrivKeyCmd(wif, &label, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *bronutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	...
	cmd := bronjson.NewImportPrivKeyCmd(wif, &label, &rescan)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPubKeyAsync(pubKey string) FutureImportPubKeyResult {
	cmd := bronjson.NewImportPubKeyCmd(pubKey, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPubKeyRescanAsync(pubKey string, rescan bool) FutureImportPubKeyResult {
	cmd := bronjson.NewImportPubKeyCmd(pubKey, &rescan)
	return c.sendCmd(cmd)
}
...
func (r FutureGetInfoResult) Receive() (*bronjson.InfoWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes bronjson.InfoWalletResult
...
func (c *Client) GetInfo() (*bronjson.InfoWalletResult, error) {
	return c.GetInfoAsync().Receive()
}

// TODO(davec): Implement
// backupwallet (NYI in bronwallet)
// encryptwallet (Won't be supported by bronwallet since it's always encrypted)
// getwalletinfo (NYI in bronwallet or bronjson)
// listaddressgroupings (NYI in bronwallet)
// listreceivedbyaccount (NYI in bronwallet)

// DUMP
// importwallet (NYI in bronwallet)
// dumpwallet (NYI in bronwallet)
