...
See [this](https://brocointalk.org/index.php?topic=145386.0) thread on
brocointalk for more details.

**NOTE:** Using bootstrap.dat is entirely optional.  Brond will download the
...
[this](https://brocointalk.org/index.php?topic=145386.0) thread on brocointalk
...
**Windows:**
```bat
C:\> "%PROGRAMFILES%\Brond Suite\Brond\addblock" -i C:\Path\To\bootstrap.dat
```
