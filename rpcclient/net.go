...
// the current network.
func (r FutureGetNetworkInfoResult) Receive() (*bronjson.GetNetworkInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var networkInfo bronjson.GetNetworkInfoResult
...
func (c *Client) GetNetworkInfoAsync() FutureGetNetworkInfoResult {
	cmd := bronjson.NewGetNetworkInfoCmd()
	return c.sendCmd(cmd)
}

// GetNetworkInfo returns data about the current network.
func (c *Client) GetNetworkInfo() (*bronjson.GetNetworkInfoResult, error) {
