...
func (msg *MsgTx)BronDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	if count == 0 && enc == WitnessEncoding {
		...
		if flag[0] != 0x01 {
			...
			return messageError("MsgTx.BronDecode", str)
		}
...
// the Version field in the transaction.  This function differs fromBronDecode
// in thatBronDecode decodes from the brocoin wire protocol as it was sent
...
func (msg *MsgTx)BronEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
...
// the transaction.  This function differs fromBronEncode in thatBronEncode
...
func (msg *MsgTx) Serialize(w io.Writer) error {
	...
	//
	// Passing a encoding type of WitnessEncoding toBronEncode for MsgTx
