...
// bronees-per-byte. The transaction being funded can optionally include a
...
func keyToAddr(key *bronec.PrivateKey, net *chaincfg.Params) (bronutil.Address, error) {
