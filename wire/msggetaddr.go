...
func (msg *MsgGetAddr)BronDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	return nil
}

//BronEncode encodes the receiver to w using the brocoin protocol encoding.
// This is part of the Message interface implementation.
func (msg *MsgGetAddr)BronEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	return nil
}
