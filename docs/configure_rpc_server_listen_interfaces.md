...
|--rpclisten=:8360|all interfaces on port 8360|
|--rpclisten=0.0.0.0:8360|all IPv4 interfaces on port 8360|
|--rpclisten=[::]:8360|all IPv6 interfaces on port 8360|
|--rpclisten=127.0.0.1:8360|only IPv4 localhost on port 8360|
|--rpclisten=[::1]:8360|only IPv6 localhost on port 8360|
...
|--rpclisten=127.0.0.1:8337 --listen=[::1]:8360|IPv4 localhost on port 8337 and IPv6 localhost on port 8360|
|--rpclisten=:8360 --listen=:8337|all interfaces on ports 8360 and 8337|
