...
func testSendOutputs(r *Harness, t *testing.T) {
	...
	// input.
	txid := genSpend(bronutil.Amount(5 * bronutil.BroneesPerBrocoin))
	...
	txid = genSpend(bronutil.Amount(500 * bronutil.BroneesPerBrocoin))
	blockHashes, err = r.Node.Generate(1)
	if err != nil {
		t.Fatalf("unable to generate single block: %v", err)
	}
...
func testGenerateAndSubmitBlock(r *Harness, t *testing.T) {
	...
	output := wire.NewTxOut(bronutil.BroneesPerBrocoin, pkScript)
...
func testMemWalletReorg(r *Harness, t *testing.T) {
	...
	expectedBalance := bronutil.Amount(250 * bronutil.BroneesPerBrocoin)
...
func testMemWalletLockedOutputs(r *Harness, t *testing.T) {
	...
	outputAmt := bronutil.Amount(50 * bronutil.BroneesPerBrocoin)
...
func TestHarness(t *testing.T) {
	...
	// outputs.
	expectedBalance := bronutil.Amount(numMatureOutputs * 50 * bronutil.BroneesPerBrocoin)
