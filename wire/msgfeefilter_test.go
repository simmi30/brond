...
func TestFeeFilterLatest(t *testing.T) {
	...
	err := msg.BronEncode(&buf, pver, BaseEncoding)
	if err != nil {
	...
	err = readmsg.BronDecode(&buf, pver, BaseEncoding)
	if err != nil {
...
func TestFeeFilterWire(t *testing.T) {
	...
	for i, test := range tests {
		...
		var buf bytes.Buffer
		err := test.in.BronEncode(&buf, test.pver, BaseEncoding)
		if err != nil {
		...
		err = msg.BronDecode(rbuf, test.pver, BaseEncoding)
		if err != nil {
...
func TestFeeFilterWireErrors(t *testing.T) {
	...
	for i, test := range tests {
		...
		err := test.in.BronEncode(w, test.pver, BaseEncoding)
		...
		err = msg.BronDecode(r, test.pver, BaseEncoding)
