...
func (c *Client) DebugLevelAsync(levelSpec string) FutureDebugLevelResult {
	cmd := bronjson.NewDebugLevelCmd(levelSpec)
...
func (c *Client) CreateEncryptedWalletAsync(passphrase string) FutureCreateEncryptedWalletResult {
	cmd := bronjson.NewCreateEncryptedWalletCmd(passphrase)
	return c.sendCmd(cmd)
}
...
func (r FutureListAddressTransactionsResult) Receive() ([]bronjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListAddressTransactionsAsync(addresses []bronutil.Address, account string) FutureListAddressTransactionsResult {
	...
	cmd := bronjson.NewListAddressTransactionsCmd(addrs, &account)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a bronwallet extension.
func (c *Client) ListAddressTransactions(addresses []bronutil.Address, account string) ([]bronjson.ListTransactionsResult, error) {
...
func (r FutureGetBestBlockResult) Receive() (*chainhash.Hash, int32, error) {
	...
	var bestBlock bronjson.GetBestBlockResult
...
func (c *Client) GetBestBlockAsync() FutureGetBestBlockResult {
	cmd := bronjson.NewGetBestBlockCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureGetCurrentNetResult) Receive() (wire.BrocoinNet, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	return wire.BrocoinNet(net), nil
}
...
func (c *Client) GetCurrentNetAsync() FutureGetCurrentNetResult {
	cmd := bronjson.NewGetCurrentNetCmd()
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a brond extension.
func (c *Client) GetCurrentNet() (wire.BrocoinNet, error) {
...
func (c *Client) GetHeadersAsync(blockLocators []chainhash.Hash, hashStop *chainhash.Hash) FutureGetHeadersResult {
	...
	cmd := bronjson.NewGetHeadersCmd(locators, hash)
	return c.sendCmd(cmd)
}
...
func (c *Client) ExportWatchingWalletAsync(account string) FutureExportWatchingWalletResult {
	cmd := bronjson.NewExportWatchingWalletCmd(&account, bronjson.Bool(true))
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// session result.
func (r FutureSessionResult) Receive() (*bronjson.SessionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var session bronjson.SessionResult
...
//
// NOTE: This is a brsuite extension.
...
//
// NOTE: This is a brsuite extension.
func (c *Client) Session() (*bronjson.SessionResult, error) {
...
// NOTE: This is a brsuite extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureVersionResult) Receive() (map[string]bronjson.VersionResult,
	error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	...
	var vr map[string]bronjson.VersionResult
...
// NOTE: This is a brsuite extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) Version() (map[string]bronjson.VersionResult, error) {
