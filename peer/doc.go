...
function which allows a bronlog.Logger to be specified.  For example, logging at
...
(https://godoc.org/github.com/brsuite/brond/wire#hdr-Brocoin_Improvement_Proposals)
*/
package peer
