...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/brsuite/brond/peer)
...
```bash
$ go get -u github.com/brsuite/brond/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/brsuite/brond/peer#example-package--NewOutboundPeer)  
